...
const threeOfKind = new SumDistro({ count: 3, desc: "Sum of all dice if 3 are the same" });
const fourOfKind = new SumDistro({ count: 4, desc: "Sum all dice if 4 are the same" });

// full house scores as flat 25
const fullHouse = new FullHouse({ score: 25, desc: "25 points for a full house" });

// small/large straights score as 30/40
const smallStraight = new SmallStraight({ score: 30, desc: "30 points for a small straight" });
const largeStraight = new LargeStraight({ score: 40, desc: "40 points for a large straght" });
